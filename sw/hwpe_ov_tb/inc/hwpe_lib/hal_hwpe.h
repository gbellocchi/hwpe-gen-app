...
static inline void hwpe_nb_iter_set(unsigned int value) {
  HWPE_WRITE(value, MMULT_OPT_MDC_REG_NB_ITER);
}

static inline void hwpe_linestride_set(unsigned int value) {
  HWPE_WRITE(value, MMULT_OPT_MDC_REG_LINESTRIDE);
}

static inline void hwpe_tilestride_set(unsigned int value) {
  HWPE_WRITE(value, MMULT_OPT_MDC_REG_TILESTRIDE);
}

static inline void hwpe_len_iter_set_out_r(unsigned int value) {
  HWPE_WRITE(value, MMULT_OPT_MDC_REG_CNT_LIMIT_OUT_R);
}
...
{
  HWPE_WRITE(in1_trans_size,    MMULT_OPT_MDC_REG_IN1_TRANS_SIZE  );
  HWPE_WRITE(in1_line_stride,   MMULT_OPT_MDC_REG_IN1_LINE_STRIDE );
  HWPE_WRITE(in1_line_length,   MMULT_OPT_MDC_REG_IN1_LINE_LENGTH );
  HWPE_WRITE(in1_feat_stride,   MMULT_OPT_MDC_REG_IN1_FEAT_STRIDE );
  HWPE_WRITE(in1_feat_length,   MMULT_OPT_MDC_REG_IN1_FEAT_LENGTH );
  HWPE_WRITE(in1_feat_roll,     MMULT_OPT_MDC_REG_IN1_FEAT_ROLL   );
  HWPE_WRITE(in1_loop_outer,    MMULT_OPT_MDC_REG_IN1_LOOP_OUTER  );
  HWPE_WRITE(in1_realign_type,  MMULT_OPT_MDC_REG_IN1_REALIGN_TYPE);
  HWPE_WRITE(in1_step,          MMULT_OPT_MDC_REG_IN1_STEP        );
}
/* address generator hal - inputs */
...
{
  HWPE_WRITE(in2_trans_size,    MMULT_OPT_MDC_REG_IN2_TRANS_SIZE  );
  HWPE_WRITE(in2_line_stride,   MMULT_OPT_MDC_REG_IN2_LINE_STRIDE );
  HWPE_WRITE(in2_line_length,   MMULT_OPT_MDC_REG_IN2_LINE_LENGTH );
  HWPE_WRITE(in2_feat_stride,   MMULT_OPT_MDC_REG_IN2_FEAT_STRIDE );
  HWPE_WRITE(in2_feat_length,   MMULT_OPT_MDC_REG_IN2_FEAT_LENGTH );
  HWPE_WRITE(in2_feat_roll,     MMULT_OPT_MDC_REG_IN2_FEAT_ROLL   );
  HWPE_WRITE(in2_loop_outer,    MMULT_OPT_MDC_REG_IN2_LOOP_OUTER  );
  HWPE_WRITE(in2_realign_type,  MMULT_OPT_MDC_REG_IN2_REALIGN_TYPE);
  HWPE_WRITE(in2_step,          MMULT_OPT_MDC_REG_IN2_STEP        );
}
...
{
  HWPE_WRITE(out_r_trans_size,    MMULT_OPT_MDC_REG_OUT_R_TRANS_SIZE  );
  HWPE_WRITE(out_r_line_stride,   MMULT_OPT_MDC_REG_OUT_R_LINE_STRIDE );
  HWPE_WRITE(out_r_line_length,   MMULT_OPT_MDC_REG_OUT_R_LINE_LENGTH );
  HWPE_WRITE(out_r_feat_stride,   MMULT_OPT_MDC_REG_OUT_R_FEAT_STRIDE );
  HWPE_WRITE(out_r_feat_length,   MMULT_OPT_MDC_REG_OUT_R_FEAT_LENGTH );
  HWPE_WRITE(out_r_feat_roll,     MMULT_OPT_MDC_REG_OUT_R_FEAT_ROLL   );
  HWPE_WRITE(out_r_loop_outer,    MMULT_OPT_MDC_REG_OUT_R_LOOP_OUTER  );
  HWPE_WRITE(out_r_realign_type,  MMULT_OPT_MDC_REG_OUT_R_REALIGN_TYPE);
  HWPE_WRITE(out_r_step,          MMULT_OPT_MDC_REG_OUT_R_STEP        );
}

/* basic hal */

static inline void hwpe_trigger_job() {
  HWPE_WRITE(0, MMULT_OPT_MDC_REG_TRIGGER);
}

static inline int hwpe_acquire_job() {
  return HWPE_READ(MMULT_OPT_MDC_REG_ACQUIRE);
}

static inline unsigned int hwpe_get_status() {
  return HWPE_READ(MMULT_OPT_MDC_REG_STATUS);
}

static inline void hwpe_soft_clear() {
  volatile int i;
  HWPE_WRITE(0, MMULT_OPT_MDC_REG_SOFT_CLEAR);
}
...
static inline void hwpe_bytecode_set(unsigned int offs, unsigned int value) {
  HWPE_WRITE(value, MMULT_OPT_MDC_REG_BYTECODE+offs);
}
...
static inline void hwpe_in1_addr_set(int32_t value) {
  HWPE_WRITE(value, MMULT_OPT_MDC_REG_IN1_ADDR);
}
// input in2
static inline void hwpe_in2_addr_set(int32_t value) {
  HWPE_WRITE(value, MMULT_OPT_MDC_REG_IN2_ADDR);
}

// output out_r
static inline void hwpe_out_r_addr_set(int32_t value) {
  HWPE_WRITE(value, MMULT_OPT_MDC_REG_OUT_R_ADDR);
}
