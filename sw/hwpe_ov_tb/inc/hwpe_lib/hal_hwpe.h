 ...
 *     6  |  0x005c  |  31: 0  |  0xffffffff  ||  HWPE_N_TOTAL_REQS

 *     7  |  0x0060  |  31: 0  |  0xffffffff  ||  HWPE_T_CK_REQS

 *     8  |  0x0064  |  31: 0  |  0xffffffff  ||  HWPE_T_CK_IDLE
 * ================================================================================
 *
 */
...
/* custom hal */
static inline void hwpe_n_total_reqs_set(int32_t value) {
  HWPE_WRITE(value, TRAFFIC_GEN_REG_N_TOTAL_REQS );
}
static inline void hwpe_t_ck_reqs_set(int32_t value) {
  HWPE_WRITE(value, TRAFFIC_GEN_REG_T_CK_REQS );
}
static inline void hwpe_t_ck_idle_set(int32_t value) {
  HWPE_WRITE(value, TRAFFIC_GEN_REG_T_CK_IDLE );
}
